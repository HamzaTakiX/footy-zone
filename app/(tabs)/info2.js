...
export default function InfoScreen() {
  ...
  const handleGesture = Animated.event(
    ...
    { 
      ...
      listener: ({ nativeEvent }) => {
        ...
        if (newValue <= windowWidth && newValue >= -windowWidth) {
  ...
  const handleGestureEnd = ({ nativeEvent }) => {
    ...
    } else if (nativeEvent.translationX > windowWidth / 3) {
      Animated.spring(slideAnim, {
        toValue: windowWidth,
        tension: 40,
        friction: 7,
        ...
        >
          <View style={styles.topSection}>
            ...
            <Image
              ...
              style={[styles.logo, { transform: [{ translateY: parallaxAnim }] }]}
              resizeMode="contain"
            />
          </View>
